...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6283162388082@s.whatsapp.net`]
      ...
      message: {
        productMessage: {
          product: {
            ...
            description: "NDAABOTZ",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "Nanda Style",
            productImageCount: 1,
          },
...
// Katalog
const reply = (teks) => {
             res = itsmevall.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*Nanda Style*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6283162388082`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6283162388082`,
                "thumbnailUrl": "https://j.top4top.io/p_20682m4yj0.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6283162388082`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6283162388082@s.whatsapp.net";
...
*「 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦︎', imageMessage: imageMsg,
...
case 'bugreport':
              ...
              itsmevall.sendMessage('6283162388082@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://instagram.com/nnda.krnwn_')
break
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://youtube.com/c/Nanda Style"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        itsmevall.toggleDisappearingMessages(from, 0)
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦 シ︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
㋛${prefix}kickarea
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
㋛${prefix}upswlokasi
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
case 'katalog':
    ...
    "listMessage": {
      ...
      "footerText": " 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦"
    }
  }, {quoted: freply})
...
sendButMessage(from, tiyo, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦︎`, [
            {              
...
itsmevall.sendMessage(_.jid, 
			...
			"footerText": '𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦︎',
			"buttons": [
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @𝙣𝙣𝙙𝙖.𝙠𝙧𝙣𝙬𝙣_ ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
case 'anal':
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @𝙣𝙣𝙙𝙖.𝙠𝙧𝙣𝙬𝙣_ ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
...
case 'listnulis':
  ...
  🌹 ${prefix}nulis Nanda
  🌹 ${prefix}foliokanan Nanda
  🌹 ${prefix}foliokiri Nanda
  🌹 ${prefix}nuliskanan Nanda
  🌹 ${prefix}nuliskiri Nanda`)
  break
case 'foliokiri':
if (!c) return reply('Textnya mana gan?')
reply(mess.wait)
